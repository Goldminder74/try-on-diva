...
const BUYER_QA: QA[] = [
  ...
  },
  {
    ...
    a: "You get 2 free try-ons a month without an account, and 5 every month once you create a free account - no card required. Each try-on gives you front, side and back views, and the count resets on the 1st of each month.",
  },
  {
