...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Virtual wig try-on built for Black women. Browse hundreds of styles, see them on your skin in seconds." },
      ...
      { name: "twitter:description", content: "Virtual wig try-on built for Black women. Browse hundreds of styles, see them on your skin in seconds." },
