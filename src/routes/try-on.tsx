                ...
                {list.map((w: Wig) => (
                  ...
                  >
                    ...
                    <div className="px-1 py-1.5">
                      <p className="text-[11px] leading-tight break-words text-foreground">{w.name}</p>
                      {!scoped && (
                        <p className="mt-0.5 text-[10px] leading-tight break-words text-muted-foreground">{w.retailer}</p>
                      )}
                    </div>
                  </button>
                ))}
